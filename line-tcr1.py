...
cl = LINETCR.LINE()
cl.login(token="EmKE7Q6JQvcXml3p7c24.k2K4G8GMT6aSz/sjRTTG5a.Ja9krwPVJqaSarNaElPv880lrgdbVqIps+lWd4Zablg=")
cl.loginResult()
...
ks = LINETCR.LINE()
ks.login(token="EmydILfPOft3V35cH3dd.Vn3x60GkkbhMA+Th+FV6tq.gs22aAdzE5T1R+S9Rct+bXZPoY7d4ti+pvvFhuPvMt0=")
ks.loginResult()
...
║[All mid]:
║[Me]:
║[Join all]: "join all bot via qr"
║[Usir 1/2/3/4:]: "Kick kicker"
...
admins = ["uec13f3c18fd696fe7c2ffd4c7e001a31"]
Rx3 = ["uec13f3c18fd696fe7c2ffd4c7e001a31"]
Rx2 = ["uec13f3c18fd696fe7c2ffd4c7e001a31"]
Rx1 = ["uec13f3c18fd696fe7c2ffd4c7e001a31"]
...
#-----------------------------------------------------------                          
				...
				OWN = "u34ee039974520f5d51b5b4f19807715c"
				if msg.from_ in OWN:
					pass
				else:
				...
				OWN = "ua576b5d6e55febf3a22758f65e1bc687"
				if msg.from_ in OWN:
					pass
				else:
				...
				OWN = "udf3209a89fbf8728feffd9ed831b436d"
				if msg.from_ in OWN:
					pass
				else:
            ...
            try:
                if op.param3 in mid:
                    ...
                    if op.param1 in protection:
                        OWN = "ub736c5b1794f5aa30026d162d07ce5e6","u34ee039974520f5d51b5b4f19807715c","ua576b5d6e55febf3a22758f65e1bc687","udf3209a89fbf8728feffd9ed831b436d"
                    if op.param2 in OWN:
